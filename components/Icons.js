...
export const MagicWandIcon = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="m13 2 2 2.5L18 2l-1.5 4L18 8.5 15 7l-2 2.5L14.5 6z" />
    <path d="m14 9 1 1" />
    <path d="m15 12 2 2" />
    <path d="m17.6 14.6 1.6 1.6" />
    <path d="m19 17 3 3" />
    <path d="M10 10l1.5 2" />
    <path d="M7 21l3-3" />
    <path d="M3.5 18.5l2-2" />
    <path d="M2 17l1-1" />
    <path d="M2 14l2.5-2L2 9.5 6 11l2.5-3L7 12l2.5 2L6 12.5z" />
  </svg>
);

export const PaletteIcon = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.688 0-.437-.347-.851-.591-1.252-.204-.345-.435-.735-.435-1.103 0-.927.703-1.641 1.641-1.641h2.09c3.153 0 5.647-2.525 5.647-5.647C22 6.202 17.542 2 12 2z" />
